...
export default function CartPage() {
  ...
  return (
    <motion.div className="w-full max-w-[1600px] mx-auto px-4 mt-[calc(var(--mobile-top-offset)+16px)] lg:mt-[140px] mb-20 md:mb-40" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
      ...
      <div className="flex flex-col lg:flex-row w-full gap-6 md:gap-70 min-h-[400px] h-full">
        <motion.div className="cart-items w-full lg:w-3/5 max-h-[calc(var(--app-dvh)-300px)] md:h-[calc(var(--app-dvh)-220px)] overflow-y-auto pr-2 min-h-[340px] h-full flex flex-col" initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.5, delay: 0.2 }}>
          <CartItemSection />
        </motion.div>
