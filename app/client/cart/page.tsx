...
export default function Cart() {
    ...
    return (
        <motion.div 
            className="w-full max-w-[1600px] mx-auto px-4 mt-[80px] md:mt-[140px] mb-20 md:mb-40"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
            ...
            <div className="flex flex-col lg:flex-row w-full gap-6 md:gap-70 min-h-[400px] h-full">
                <motion.div 
                    className="cart-items w-full lg:w-3/5 max-h-[calc(100vh-300px)] md:h-[calc(100vh-200px)] overflow-y-auto pr-2 min-h-[340px] h-full flex flex-col"
                    ...
                    <div className="block lg:hidden">
                        ...
                        <AnimatePresence>
                            {showOrderForm && (
                                ...
                                >
                                    <motion.div 
                                        className="relative bg-[#FFF8F8] p-6 rounded-2xl shadow-lg w-full max-w-md mx-auto"
