...
export const metadata: Metadata = {
  ...
  title: {
    default: "Floramix - Доставка цветов и букетов в Красноярске",
    template: "%s | Floramix",
  },
  description: "Floramix - интернет-магазин цветов с доставкой в Красноярске. Свежие букеты, композиции и цветочные подарки на любой случай. Быстрая доставка, гарантия качества.",
  keywords: ["цветы", "букеты", "доставка цветов", "купить цветы", "цветочный магазин", "floramix", "флорамикс", "доставка цветов красноярск", "купить цветы красноярск", "цветы красноярск"],
  ...
  verification: {
    google: '6zB6XfHUFXsXq0TcVLIfZtshkoA-hLAIi0yxeNoS4w4',
  },
};
